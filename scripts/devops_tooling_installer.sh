...
sudo pacman -Sy --noconfirm --needed podman-dnsname podman-docker aardvark-dns netavark podman podman-compose terragrunt aws-cli-v2 kubectl helm go minikube terraform-docs
